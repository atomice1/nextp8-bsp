...
#define _SCREEN_TRANSFORM   (_MEMIO_BASE + 0xa1)
#define _HIGH_COLOUR_MODE   (_MEMIO_BASE + 0xa3)
#define _KEYBOARD_EVENT_QUEUE (_MEMIO_BASE + 0xa8)
#define _KEYBOARD_EVENT_QUEUE_HI (_MEMIO_BASE + 0xa8)
#define _KEYBOARD_EVENT_QUEUE_LO (_MEMIO_BASE + 0xaa)
...
#define _DA_CLKS_PER_SECOND 65000000
...
#define _SECONDARY_PALETTE_BASE 0xc08030
#define _HIGH_COLOUR_BITFIELD_BASE 0xc08040
...
extern int _esp_read_byte(unsigned char *byte, unsigned timeout_us);
